...
export class RunesService {
  ...
  domination = {
    ...
    keystone: [
        {
          name: "Electrocute",
          image: this.basePath + "domination/domination-keystone-1.png",
        ...
        {
          name: "Predator",
          image: this.basePath + "domination/domination-keystone-2.png",
        ...
        {
          name: "Dark Harvest",
          image: this.basePath + "domination/domination-keystone-3.png",
      ...
      slot1: [
        {
          name: "Cheap Shot",
          image: this.basePath + "domination/domination-slot-1-1.png",
        ...
        {
          name: "Taste of Blood",
          image: this.basePath + "domination/domination-slot-1-2.png",
        ...
        {
          name: "Sudden Impact",
          image: this.basePath + "domination/domination-slot-1-3.png",
      ...
      slot2: [
        {
          name: "Zombie Ward",
          image: this.basePath + "domination/domination-slot-2-1.png",
        ...
        {
          name: "Ghost Poro",
          image: this.basePath + "domination/domination-slot-2-2.png",
        ...
        },
        {
          ...
          image: this.basePath + "domination/domination-slot-2-3.png",
      ...
      slot3: [
        {
          ...
          image: this.basePath + "domination/domination-slot-3-1.png",
        ...
        },
        {
          ...
          image: this.basePath + "domination/domination-slot-3-2.png",
          description: "Unique takedowns grant permanent Active Item CDR (including trinkets).",
          highlightPrimary: true,
          highlightSecondary: true,
          comments: "This talent is incredible if you are using multiple activated items in your build. This talent almost cuts their cooldown in half, which supercharges the value of these items. Items of choice include: <img class=\"image-inline-sm\" src=\"./assets/images/items/banner-of-command.png\" alt=\"Banner of Command Icon\"/> Banner of Command, <img class=\"image-inline-sm\" src=\"./assets/images/items/zzrot-portal.png\" alt=\"ZZ'Rot Portal Icon\"/> ZZ'Rot Portal, <img class=\"image-inline-sm\" src=\"./assets/images/items/redemption.png\" alt=\"Redemption Icon\"/> Redemption, and <img class=\"image-inline-sm\" src=\"./assets/images/items/locket-of-the-iron-solari.png\" alt=\"Locket of the Iron Solari Icon\"/> Locket of the Iron Solari."
        },
        {
          name: "Relentless Hunter",
          image: this.basePath + "domination/domination-slot-3-3.png",
    ...
    sorcery = {
      primaryImage: this.basePath + "sorcery/sorcery-main.png",
      name: "sorcery",
      keystone: [
        {
          name: "Summon Aery",
          image: this.basePath + "sorcery/sorcery-keystone-1.png",
        ...
        {
          name: "Arcane Comet",
          image: this.basePath + "sorcery/sorcery-keystone-2.png",
        ...
        {
          name: "Phase Rush",
          image: this.basePath + "sorcery/sorcery-keystone-3.png",
      ...
      slot1: [
        {
          name: "Nullifying Orb",
          image: this.basePath + "sorcery/sorcery-slot-1-1.png",
        ...
        {
          name: "Manaflow Band",
          image: this.basePath + "sorcery/sorcery-slot-1-2.png",
      ...
      slot2: [
        {
          name: "Transcendence",
          image: this.basePath + "sorcery/sorcery-slot-2-1.png",
        ...
        {
          name: "Celerity",
          image: this.basePath + "sorcery/sorcery-slot-2-2.png",
        ...
        {
          name: "Absolute Focus",
          image: this.basePath + "sorcery/sorcery-slot-2-3.png",
      ...
      slot3: [
        {
          name: "Scorch",
          image: this.basePath + "sorcery/sorcery-slot-3-1.png",
        ...
        {
          name: "Waterwalking",
          image: this.basePath + "sorcery/sorcery-slot-3-2.png",
        ...
        },
        {
          ...
          image: this.basePath + "sorcery/sorcery-slot-3-3.png",
    ...
    inspiration = {
      ...
      keystone: [
        {
          ...
          image: this.basePath + "inspiration/inspiration-keystone-1.png",
        ...
        },
        {
          ...
          image: this.basePath + "inspiration/inspiration-keystone-2.png",
        ...
        {
          name: "Kleptomancy",
          image: this.basePath + "inspiration/inspiration-keystone-3.png",
      ...
      slot1: [
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-1-1.png",
        ...
        },
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-2-1.png",
        ...
        {
          name: "Perfect Timing",
          image: this.basePath + "inspiration/inspiration-slot-1-3.png",
      ...
      slot2: [
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-2-2.png",
        ...
        },
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-2-3.png",
        ...
        },
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-1-2.png",
      ...
      slot3: [
        {
          name: "Cosmic Insight",
          image: this.basePath + "inspiration/inspiration-slot-3-1.png",
        ...
        },
        {
          ...
          image: this.basePath + "inspiration/inspiration-slot-3-2.png",
    ...
    precision = {
      primaryImage: this.basePath + "precision/precision-main.png",
      name: "precision",
      keystone: [
        {
          name: "Press the Attack",
          image: this.basePath + "precision/precision-keystone-1.png",
        ...
        {
          name: "Lethal Tempo",
          image: this.basePath + "precision/precision-keystone-2.png",
      ...
      slot1: [
        {
          name: "Overheal",
          image: this.basePath + "precision/precision-slot-1-1.png",
        ...
        {
          name: "Triumph",
          image: this.basePath + "precision/precision-slot-1-2.png",
        ...
        },
        {
          ...
          image: this.basePath + "precision/precision-slot-1-3.png",
      ...
      slot2: [
        {
          ...
          image: this.basePath + "precision/precision-slot-2-1.png",
        ...
        },
        {
          ...
          image: this.basePath + "precision/precision-slot-2-2.png",
        ...
        },
        {
          ...
          image: this.basePath + "precision/precision-slot-2-3.png",
      ...
      slot3: [
        {
          name: "Coup De Grace",
          image: this.basePath + "precision/precision-slot-3-1.png",
        ...
        {
          name: "Cut Down",
          image: this.basePath + "precision/precision-slot-3-2.png",
        ...
        {
          name: "Last Stand",
          image: this.basePath + "precision/precision-slot-3-3.png",
