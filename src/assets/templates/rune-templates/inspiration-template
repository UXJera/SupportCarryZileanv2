...
runeArrayPrimary = [
  [ new Rune('Unsealed Spellbook', this.inspirationShortcut + 'inspiration-keystone-1.png',
    ...
    "Your first attack after using an ability grants gold and sometimes consumables."),
  ],
  [
    ...
    'Get a Biscuit every 3 mins, until 12 mins. Biscuits restore health and mana. Consuming a Biscuit permanently increases your max mana.'),
